...
/**
 * View 44 — Centered tabs (like #41) + each card individually
 * styled as a StackCard with rotation/accordion hover (like #2).
 * Two columns, each card is its own little tilted stack item.
 */
export const TabCardsView = ({ sections, visible }: TabCardsViewProps) => {
  ...
  return (
    <div className="w-full max-w-4xl mx-auto px-3 sm:px-4 pt-4" dir="rtl">
      {/* Centered tab bar — identical to TabsView */}
      <div
      ...
      {/* Two columns — each card is an individual StackCard with accordion */}
