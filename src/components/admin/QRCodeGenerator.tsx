      ...
      <div data-ev-id="ev_cdfe341503" className="flex flex-col sm:flex-row gap-5 items-start">
        ...
        <div data-ev-id="ev_a2dc158579" className="flex flex-col items-center gap-3 flex-shrink-0">
          ...
          <div data-ev-id="ev_526c9b0357" className="flex gap-2">
            ...
            aria-label="הורד QR"
            className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs text-white/60 hover:text-white/70 border border-white/[0.08] hover:border-white/[0.15] transition-all focus:outline-none focus-visible:ring-2 focus-visible:ring-primary">
        ...
        <div data-ev-id="ev_e223bb39f0" className="flex-1 space-y-3 w-full">
          <div data-ev-id="ev_566f518584">
            <label data-ev-id="ev_76f7bfe3b3" htmlFor="qr-url" className="text-white/60 text-xs font-medium mb-1.5 block">כתובת האתר</label>
          ...
          <p data-ev-id="ev_60a0bd5f8e" className="text-white/60 text-xs leading-relaxed">
